var city = {
    ...
    province: ['-请选择-', "广西壮族自治区", "广东省", '北京市', '天津市', "河北省", "内蒙古自治区", "辽宁省", "吉林省", "黑龙江省", "上海市", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "海南省", "重庆省", "四川省", "贵州省", "云南省", "西藏自治区", "陕西省", "甘肃省", "青海省", "宁夏回族自治区", "新疆维吾尔自治区", "台湾省", "澳门", "香港", "钓鱼岛", "其他"],
    city: {
        '-请选择-': ['-请选择-'],
        ...
        "内蒙古自治区": ["呼和浩特", "包头", "乌海", "赤峰", "呼伦贝尔", "兴安", "通辽", "锡林郭勒盟", "乌兰察布盟", "伊克昭盟", "伊克昭盟", "巴彦淖尔盟", "阿拉善盟"],
